...
extension OTRSettingsViewController {
    public override class func initialize() {
        ...
        dispatch_once(&Static.token) {
            zom_swizzle(#selector(OTRSettingsViewController.presentViewController(_:animated:completion:)), swizzledSelector:#selector(OTRSettingsViewController.zom_presentViewController(_:animated:completion:)))
            zom_swizzle(#selector(OTRSettingsViewController.logoutAccount(_:sender:)), swizzledSelector: #selector(OTRSettingsViewController.zom_logoutAccount(_:sender:)))
        }
    }
